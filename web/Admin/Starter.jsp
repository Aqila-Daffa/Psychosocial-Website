<%-- 
    Document   : starter
    Created on : Jan 18, 2022, 11:16:03 AM
    Author     : ASUS
--%>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <br>Click "User List" button to see the user detail such as name, ID, phone number and email.
                                    </p>

                                    <a href="UsrList.jsp" class="card-link">Click here</a>
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <br>Click "Apppointment List" button to see the user name, appointment date, and appointment venue
                                    </p>
                                    <a href="AptList.jsp" class="card-link">Click here</a>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Click "Transaction List" to see user name and their payment status</p>
                                    <a href="TransList.jsp" class="btn btn-primary">Click here</a>
                                </div>
                            </div>

                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="m-0">Psychologist List</h5>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title"></h6>

                                    <p class="card-text">Click "Psychologist List" to see psychologist in duty</p>
                                    <a href="PsyList.jsp" class="btn btn-primary">Click Here</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.col-md-6 -->
