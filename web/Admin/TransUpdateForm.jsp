<%-- 
    Document   : TransUpdateForm
    Created on : Jan 28, 2022, 6:53:15 PM
    Author     : ASUS
--%>
...
<body class="hold-transition sidebar-mini">
 ...
 <form action="../UpdateTrans" method="post"> 
  <table>
      ...
      <%    
            ...
            String query = "SELECT * FROM transactions WHERE paymentId =? ";
...
%>
  ...
  <tr>
    ...
    <td><input type="text" name="transId" value="<%= transId %>" readonly></td>          
  </tr>
  <tr>
  ...
  <tr>
    <th>Payment ID</th>
    <td><input type="text" name="payId" value="<%= payId %>" readonly></td>
  </tr>
  <tr>
