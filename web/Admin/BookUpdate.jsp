<%-- 
    Document   : BookUpdate
    Created on : Jan 29, 2022, 10:45:18 PM
    Author     : ASUS
--%>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">User Booking List Page</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="Starter.jsp">Home</a></li>
                                <li class="breadcrumb-item active">User Booking List Page</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
...
<table>
  ...
  <%        
            ...
            ResultSet rslt=st.executeQuery(query3);
            while(rslt.next()){              
%>
  <tr>
  <form action="BookUpdateForm.jsp" method="POST">
    <td><input type="text" name="book" value="<%= rslt.getInt(1) %>" readonly></td>
    <td><%= rslt.getString(2) %></td>
    <td><%= rslt.getString(3) %></td>
    <td><%= rslt.getString(4) %></td>
    <td><%= rslt.getString(5) %></td>   
    <td><button type="submit" class="btn btn-dark"><%= rslt.getString(6) %></button></td>
  </form>  
 </tr>
 <%
               }
