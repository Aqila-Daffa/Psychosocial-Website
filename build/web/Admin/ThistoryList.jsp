<%-- 
    Document   : ThistoryList
    Created on : Jan 28, 2022, 3:01:47 PM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <title>Transaction History List Page</title>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="ThistoryList.jsp" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Transaction History List Page</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="Starter.jsp">Home</a></li>
                                <li class="breadcrumb-item active">Transaction History List Page</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
...
<table>
  ...
  <%          
            String query = "SELECT * FROM transactions WHERE statusTransaction = 'Approved'";
...
%>
  <tr>
  <form action="TransUpdateForm.jsp" method="POST">
