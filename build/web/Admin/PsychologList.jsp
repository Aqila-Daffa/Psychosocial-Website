<%-- 
    Document   : PsychologList
    Created on : Jan 28, 2022, 4:31:56 PM
    Author     : ASUS
--%>
...
%>
  <tr>
  <form action="PsyUpdateForm.jsp" method="POST">  
    <td><input type="psyc" name="psyc" value="<%= rs.getInt(1) %>" size="2" readonly></td>
...
%>
                    ...
                    <!-- Back button -->
    <a href="PsyList.jsp" class="btn btn-dark mt-4" style="width: 150px; margin-left: 400px;margin-bottom: -20px;">BACK</a>
                <!-- /.container-fluid -->
            </div>
            <!-- /.content -->
        </div>
