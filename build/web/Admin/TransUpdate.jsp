<%-- 
    Document   : TransUpdate
    Created on : Jan 28, 2022, 6:28:48 PM
    Author     : ASUS
--%>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Transaction List Page</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="Starter.jsp">Home</a></li>
                                <li class="breadcrumb-item active">Transaction List Page</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
...
%>
  ...
  <form action="TransUpdateForm.jsp" method="POST">
    ...
    <td><%= rs.getInt(3) %></td>
    <td><input type="text" name="payment" value="<%= rs.getInt(4) %>" readonly></td>
    <td><button type="submit" class="btn btn-dark"><%= rs.getString(2) %></button></td>
  </form>  
 </tr>
 <%
               }
