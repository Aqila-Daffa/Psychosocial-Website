<%-- 
    Document   : psyList
    Created on : Jan 18, 2022, 11:17:25 AM
    Author     : ASUS
--%>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Psychologist Page</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="Starter.jsp">Home</a></li>
                                <li class="breadcrumb-item active">Psychologist Page</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="m-0">Add Psychologist</h5>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title"></h6>
                                    <p class="card-text">Click "Add Psychologist" to add Psychologist</p>
                                    <a href="AddPsychologist.jsp" class="btn btn-primary">Click here</a>
                                </div>
                            </div>
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="PsychologList.jsp" class="btn btn-primary">Click Here</a>
                                </div>
                            </div>
                        </div>
                <!-- /.container-fluid -->
